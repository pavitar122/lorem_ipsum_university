...
<header class="h-[50vh] bg-cover bg-center bg-gradient-to-r from-slate-200 to-green-300 px-40 pt-40">
    ...
    <h1 class="text-6xl font-bold mb-4 text-gray-800">Past Events</h1>
...
<?php if ($past_event_query->have_posts()): ?>
    <?php while ($past_event_query->have_posts()): $past_event_query->the_post(); ?>
